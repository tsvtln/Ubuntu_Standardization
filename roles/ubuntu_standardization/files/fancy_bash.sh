...
#local PROMT_FORMAT="\[\033[1;38;5;74m\]"  # blue text, no bg
...
#PS1="$TITLEBAR${PROMT_HOST}${SEPARATOR_2}${PROMT_PWD}"
 PS1="$TITLEBAR${PROMT_HOST}${SEPARATOR_2}${PROMT_PWD}${SEPARATOR_3}${PROMT_INPUT}\[\033[0m\]"
